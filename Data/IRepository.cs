...
namespace SmartSchool_WebApi.Data
{
    public interface IRepository
    {
        ...
        Task GetAlunoAsyncById(bool v);

        //Utilizador 
        Task<Utilizador[]> GetAllUtilizadoresAsync();
        Task<Utilizador> GetUtilizadorAsyncById(int utilizadorId);
        Task<Utilizador> GetEmailPasswordAsync( string password,string email);
